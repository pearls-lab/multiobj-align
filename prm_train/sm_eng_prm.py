...
Based on engagement prefixes dataset with binary labels (0 and 1)
"""
...
class RewardModelTrainer:
    def __init__(
        ...
        batch_size: int = 32,
        num_epochs: int = 5,  # Reduce epochs to prevent overfitting
    ...
    def load_and_process_dataset(self, dataset_name: str) -> DatasetDict:
        """Load and process the engagement prefixes dataset"""
...
def main():
    ...
    wandb.init(
        ...
        name="llama3.1-8b-reward-model-1e5-bz32",
        config={
    ...
    trainer = RewardModelTrainer(
        ...
        output_dir="./llama_reward_model_1e5-bz32",
    )

    # Load and process dataset
    dataset = trainer.load_and_process_dataset("Jennny/final_eng_rate_latest2")
