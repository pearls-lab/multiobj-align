...
# Import the MultiHeadCausalLM model (if available)
try:
...
# ---- NEW: tiny containers for running state and candidates ----
...
class UnifiedStepByStepDecoder:
    ...
    def generate_candidates_vllm(
        ...
        # Update generation params for this call
    ...
    # ===== NEW: unified-RM evaluator for Candidate objects =====
    ...
    # ===== NEW: model/head picker used by initial and step forwards =====
    ...
    # ===== NEW: seed the running cache once from the chat prompt =====
    ...
    # ===== NEW: sample a single candidate chunk from a given KV state =====
    ...
    # ===== NEW: propose N candidates from the same running cache =====
    ...
    # ===== NEW: adopt the chosen candidate's cache as the new running state =====
