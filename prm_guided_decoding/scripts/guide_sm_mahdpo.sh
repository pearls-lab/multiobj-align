#!/bin/bash
# Complete Socratic Mind Workflow with MAH-DPO Model + Candidate Selection
...
CANDIDATES_FILE="results/sm_mahdpo_candidates_split${SPLIT_INDEX}.jsonl"
TRANSFORMED_CANDIDATES_FILE="results/sm_mahdpo_candidates_transformed_split${SPLIT_INDEX}.jsonl"
BEST_FILE="results/sm_mahdpo_best_split${SPLIT_INDEX}.jsonl"
FINAL_FILE="results/sm_mahdpo_with_student_split${SPLIT_INDEX}.jsonl"
GPU_ID=0
